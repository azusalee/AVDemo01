...
- (KFDemuxerConfig *)demuxerConfig {
    if (!_demuxerConfig) {
        ...
        // 待解封装的资源。
        //NSString *assetPath = [[NSBundle mainBundle] pathForResource:@"test" ofType:@"m4a"];
        NSString *assetPath = [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"test.m4a"];
